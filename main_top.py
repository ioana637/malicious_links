...
from algorithms.svm import run_best_configs_SVM_linear, run_best_configs_SVM_poly, run_best_configs_SVM_sigmoid, \
    run_best_configs_SVM_RBF
from algorithms.xgb import run_best_configs_xgb
...
# ----------------------------- SVM linear -----------------------------------------
# df_configs_svm_linear = pd.read_csv('new_results/svm/best-lin.csv')
...
#
# ------------------------------SVM RBF kernel -----------------------------------------
# df_configs_svm_RBF = pd.read_csv('new_results/svm/best-rbf.csv')
