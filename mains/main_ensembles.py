...
def run_ensemble_algs(algs: [Algorithms], no_repeats=10, train_size=0.8, filename_standard='', filename_min_max=''):
    path_to_script = os.path.dirname(os.path.abspath(__file__))
...
def main():
    ...
    for combo in combos:
        run_ensemble_algs(combo, no_repeats=100, train_size=0.8, filename_standard=filename_standard,
